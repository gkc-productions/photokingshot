  ...
  return (
    <section className="section-shell grid gap-10 py-16 md:grid-cols-[1.05fr_0.95fr] md:py-24">
      <div className="flex flex-col justify-center">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight text-[var(--foreground)] md:text-6xl">Access your edited PhotoKingShot gallery.</h1>
        <p className="muted-copy mt-5 max-w-2xl text-lg leading-8">
          Your finished images are delivered in a private online gallery. Enter the gallery code and password provided by PhotoKingShot to view and download your edits.
        </p>
      ...
      <div>
        ...
        <GalleryLoginForm />
        <p className="gold-notice mt-5 rounded-sm p-4 text-sm">Your private gallery link is sent after your session is edited and ready for delivery.</p>
      </div>
    </section>
  );
}
