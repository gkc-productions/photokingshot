...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Edited PhotoKingShot galleries are delivered securely online.",
...
export default function GalleriesPage() {
  return (
    <section className="section-shell py-16 md:py-24">
      ...
      <div className="surface-card mt-10 rounded-sm p-7">
        <p className="text-xl font-black">Your gallery link will be sent after your session is edited.</p>
        <p className="muted-copy mt-3 max-w-2xl leading-7">Future Evoto or Instant Gallery links can be connected here once the final gallery workflow is selected.</p>
        <Button href="/booking" className="mt-7">Request Gallery Link</Button>
      </div>
    </section>
  );
}
